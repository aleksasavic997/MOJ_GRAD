...
class PageBodyDesktop extends StatefulWidget {
  @override
  PageBodyDesktopState createState() => PageBodyDesktopState();
}

class PageBodyDesktopState extends State<PageBodyDesktop> {
          ...
          children: <Widget>[
            ...
            Stack(
              ...
              children: <Widget>[
                ...
                HomePage.notificationShow == true
                    ? showNotifications()
                    : Text(''),
            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  ...
                  Icon(menuIcon, color: Color.fromRGBO(24, 74, 69, 1))
                ],
              ),
            ],
          ),
